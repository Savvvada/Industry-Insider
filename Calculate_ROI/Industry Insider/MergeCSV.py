...
def prerequisite(): # This method was going to be used for individuals to create their own datasets from multiple ones by this method reading strings and infor in the csv file. It was scrapped as it became time consuming but it must be run as it changes the names of the columns and all the code afterward is built on these names
    list = os.listdir('inputting/')
